...
import profileIcon from './image1.png';
import profileIcon1 from './image2.png';
...
alt="Profile icon" style={{width:"30%"}}/>:<img src={profileIcon1} alt="Profile icon1" style={{width:"30%"}}/>}
